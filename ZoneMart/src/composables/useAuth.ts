...
export const DEMO_USERS: Record<Exclude<UserRole, "guest">, UserProfile> = {
  ...
  seller: {
    ...
    avatarUrl: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=120",
  ...
  shipper: {
    ...
    avatarUrl: "https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?auto=format&fit=crop&w=120",
  ...
  admin: {
    ...
    role: "admin",
    avatarUrl: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=120",
...
function loadInitialUser(): UserProfile | null {
  try {
    ...
    const oldRole = localStorage.getItem("userRole") as Exclude<UserRole, "guest">;
...
export function useAuth() {
  ...
  const currentRole = computed<UserRole>(() => currentUser.value?.role || "guest");
